...
Route::middleware(['api.business'])->group(function (){
    ...
    Route::middleware(['auth:api', 'verified'])->group(function (){
        Route::get('/sliders/all', [SliderController::class, 'all'])->name('api.slider.all');
        ...
        Route::post('/talent-description', [ObjectController::class, 'talentDescription'])->name('api.object.talentDescription');
