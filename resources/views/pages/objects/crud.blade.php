...
@section('content')
    ...
    <object-crud-component
        ...
        logs        =   "{{route($object->singular .  '.logs',    app()->getLocale()) . (isset($object_type) ? "?object_type=" . $object_type : "") }}"
        object_fields = "{{json_encode($object->object_fields)}}"
        object_relations = "{{json_encode($object->relations)}}"
    />
