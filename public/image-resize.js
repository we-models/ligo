...
class Toolbar extends _BaseModule__WEBPACK_IMPORTED_MODULE_4__.BaseModule {
    ...
    _defineAlignments = () => {
        this.alignments = [
            {
                icon: quill_assets_icons_align_left_svg__WEBPACK_IMPORTED_MODULE_1__["default"],
                apply: () => {
            ...
            {
                icon: quill_assets_icons_align_center_svg__WEBPACK_IMPORTED_MODULE_2__["default"],
                apply: () => {
            ...
            {
                icon: quill_assets_icons_align_right_svg__WEBPACK_IMPORTED_MODULE_3__["default"],
                apply: () => {
                    DisplayStyle.add(this.img, 'inline');
